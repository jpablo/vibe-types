# Agda Type System Constraint Guide

> Status: **Planned** — contributions welcome.

This section will map Agda's dependent type system features (universes, inductive families, instance arguments, etc.) to the constraints they can enforce at compile time.
