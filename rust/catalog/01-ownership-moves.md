...
- [→ UC-02](../usecases/02-ownership-safe-apis.md) — Designing APIs that encode ownership transfer and borrowing contracts in their signatures.
- [→ UC-05](../usecases/05-compile-time-concurrency-constraints.md) — Thread-safety relies on ownership transfer (`Send`) to prevent data races.
