...
| **L2 — behavioral uplift** | Once loaded, does the skill make Claude's code *more type-safe* than a no-skill baseline? | Per-task rollout scored by **compiler + adversarial probes** (invariant-enforcement rate) | Deterministic-anchored | ✅ built (all five languages) — [`behavioral/`](behavioral/) |
...
│   └── README.md
└── behavioral/       # L2: compiler-oracle uplift eval (all five languages)
