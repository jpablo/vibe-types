...
eval-behavioral: ## L2 eval. make eval-behavioral [MODEL=…] [RUNS=3] [TASK=…] [SKILL=rust|typescript|python|scala3|lean] [BACKEND=claude|openai] [API_BASE=http://vllm:8000/v1]
