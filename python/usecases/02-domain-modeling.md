...
| Feature | Role | Link |
|---|---|---|
| Basic annotations | Attach types to parameters, returns, and variables | [-> catalog/01](../catalog/01-basic-annotations-none.md) |
| Union / Literal | Express "one of" constraints and fixed value sets | [-> catalog/02](../catalog/02-union-literal-types.md) |
| TypedDict | Give structure to dictionaries with known keys | [-> catalog/03](../catalog/03-typeddict.md) |
| NewType | Create distinct types over the same underlying representation | [-> catalog/04](../catalog/04-newtype.md) |
| Enums | Named, closed sets of domain values | [-> catalog/05](../catalog/05-enums-typing.md) |
| Dataclasses | Structured domain entities with typed fields | [-> catalog/06](../catalog/06-dataclasses-typing.md) |
| Annotated | Attach validation metadata consumed by runtime libraries | [-> catalog/15](../catalog/15-annotated-metadata.md) |
