...
- [→ UC-04](../usecases/04-compile-time-invariants.md) — Proof automation discharges invariant proofs at construction sites.
- [→ UC-07](../usecases/07-safe-recursion-termination.md) — `omega` and `simp` are the standard tools for termination proofs.
