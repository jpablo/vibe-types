...
- [→ UC-02](../usecases/02-domain-modeling-dependent-types.md) — Coercions provide smooth conversions between domain types and their underlying representations.
- [→ UC-06](../usecases/06-generic-programming-type-classes.md) — Coercions participate in type class resolution, enabling flexible generic code.
