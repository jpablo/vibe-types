...
- [→ UC-01](../usecases/01-preventing-invalid-states.md) — Use inductive types to make invalid states unrepresentable.
- [→ UC-02](../usecases/02-domain-modeling-dependent-types.md) — Inductive families model domain invariants as type indices.
- [→ UC-03](../usecases/03-totality-exhaustiveness.md) — Exhaustive matching ensures every case is handled.
