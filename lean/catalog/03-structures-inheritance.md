...
- [→ UC-02](../usecases/02-domain-modeling-dependent-types.md) — Structures model domain entities with named fields and compile-time field requirements.
- [→ UC-08](../usecases/08-encapsulation-module-boundaries.md) — Private fields and opaque structures control what leaks across module boundaries.
