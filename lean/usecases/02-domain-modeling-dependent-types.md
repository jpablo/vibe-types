...
- [→ catalog/02](../catalog/02-dependent-types.md) — Dependent types let types depend on values.
- [→ catalog/01](../catalog/01-inductive-types.md) — Indexed inductive families model structured data with invariants.
- [→ catalog/03](../catalog/03-structures-inheritance.md) — Structures with proof fields bundle data and invariants.
- [→ catalog/14](../catalog/14-subtypes-refinements.md) — Subtypes attach predicates to existing types.
- [→ catalog/10](../catalog/10-coercions-coe.md) — Coercions provide smooth conversions between domain types.
