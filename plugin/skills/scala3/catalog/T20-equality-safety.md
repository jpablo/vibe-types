...
- [-> UC-02](../usecases/UC02-domain-modeling.md) Preventing accidental equality comparisons in domain models
- [-> UC-06](../usecases/UC13-state-machines.md) Safe equality for ADT hierarchies
- [-> UC-10](../usecases/UC17-variance.md) Hardening collection lookups with type-safe equality
