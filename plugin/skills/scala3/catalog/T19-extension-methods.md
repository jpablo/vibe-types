...
- [-> UC-01](../usecases/UC01-invalid-states.md) Type-safe builder APIs using conditional extensions
- [-> UC-03](../usecases/UC10-encapsulation.md) Newtypes with opaque types and extension methods
- [-> UC-05](../usecases/UC12-compile-time.md) Domain-specific operators via extension
- [-> UC-07](../usecases/UC14-extensibility.md) Retroactive type-class instances with extension syntax
