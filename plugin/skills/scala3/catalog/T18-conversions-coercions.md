...
- [-> UC-03](../usecases/UC10-encapsulation.md) Controlled coercion between newtypes and underlying representations
- [-> UC-04](../usecases/UC11-effect-tracking.md) Recursive codec derivation with by-name evidence
- [-> UC-08](../usecases/UC15-equality.md) Trait-level type-class requirements via deferred givens
- [-> UC-11](../usecases/UC18-type-arithmetic.md) Magnet-pattern APIs with Conversion instances
