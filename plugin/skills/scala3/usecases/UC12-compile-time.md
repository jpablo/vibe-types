...
| Feature | Role | Link |
|---|---|---|
| Inline | Compile-time evaluation, branching, and inlining | [-> T16](../catalog/T16-compile-time-ops.md)(../catalog/T16-compile-time-ops.md) |
| Match types | Type-level pattern matching; compute types from types | [-> T41](../catalog/T41-match-types.md)(../catalog/T41-match-types.md) |
| Compiletime ops | Type-level arithmetic and string operations | [-> T16](../catalog/T16-compile-time-ops.md)(../catalog/T16-compile-time-ops.md) |
| Macros | Full compile-time metaprogramming via quotes and splices | [-> T17](../catalog/T17-macros-metaprogramming.md)(../catalog/T17-macros-metaprogramming.md) |
| Type lambdas | Higher-kinded type-level functions | [-> T40](../catalog/T40-type-lambdas.md)(../catalog/T40-type-lambdas.md) |
