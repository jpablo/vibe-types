...
| Feature | Role | Link |
|---|---|---|
| Context functions | Scoped DSL blocks with an implicit receiver | [-> T42](T42-context-functions.md)(../catalog/T42-context-functions.md) |
| Extension methods | Fluent chaining without inheritance or wrappers | [-> T19](T19-extension-methods.md)(../catalog/T19-extension-methods.md) |
| Dependent function types | Return types that depend on argument values/types | [-> T53](T53-path-dependent-types.md)(../catalog/T53-path-dependent-types.md) |
| Opaque types | Lightweight wrapper types for DSL tokens and identifiers | [-> T03](T03-newtypes-opaque.md)(../catalog/T03-newtypes-opaque.md) |
| Inline | Compile-time DSL validation and expansion | [-> T16](T16-compile-time-ops.md)(../catalog/T16-compile-time-ops.md) |
| GADTs | Typed expression trees with type-safe evaluation | [-> T01](T01-algebraic-data-types.md)(../catalog/T01-algebraic-data-types.md) |
