...
| Feature | Role | Link |
|---|---|---|
| Basic annotations | Declare parameter and return types so mismatches are caught | [-> catalog/01](../catalog/01-basic-annotations-none.md) |
| Union / Literal | Restrict values to a closed set of alternatives | [-> catalog/02](../catalog/02-union-literal-types.md) |
| NewType | Create distinct types over the same underlying representation | [-> catalog/04](../catalog/04-newtype.md) |
| Enums | Define closed, named state sets with exhaustive matching | [-> catalog/05](../catalog/05-enums-typing.md) |
