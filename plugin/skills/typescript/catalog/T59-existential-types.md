...
| **Conditional Types** [-> T41](T41-match-types.md) | Conditional types can "open" a structural existential — `T extends Printable ? T['print'] : never` recovers the method signature, but cannot recover the hidden concrete type from a true continuation-encoded existential. |
