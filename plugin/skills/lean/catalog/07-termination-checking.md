...
- [→ UC-03](../usecases/03-totality-exhaustiveness.md) — Termination is one half of totality (the other is exhaustiveness).
- [→ UC-07](../usecases/07-safe-recursion-termination.md) — Patterns for writing recursive functions that pass the checker.
