...
- [→ UC-01](../usecases/01-preventing-invalid-states.md) — Prop-based preconditions make invalid states unconstructable.
- [→ UC-04](../usecases/04-compile-time-invariants.md) — Compile-time invariants are propositions that must be proved at construction.
