...
- [→ catalog/07](../catalog/07-termination-checking.md) — Termination checker verifies structural or well-founded recursion.
- [→ catalog/08](../catalog/08-totality-partial.md) — `partial` opts out of termination checking for intentionally non-terminating code.
- [→ catalog/13](../catalog/13-proof-automation.md) — `omega` and `simp` discharge termination measure proofs.
