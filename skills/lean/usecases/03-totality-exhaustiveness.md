...
- [→ catalog/01](../catalog/01-inductive-types.md) — Inductive types define the set of constructors; the compiler enforces exhaustive matching.
- [→ catalog/07](../catalog/07-termination-checking.md) — The termination checker rejects functions that might not return.
- [→ catalog/08](../catalog/08-totality-partial.md) — `partial` explicitly opts out of termination with known consequences.
