...
- [→ UC-01](../usecases/01-preventing-invalid-states.md) — Subtypes make invalid values unconstructable by requiring proof.
- [→ UC-02](../usecases/02-domain-modeling-dependent-types.md) — Model domain constraints (positive, bounded, non-empty) as subtype predicates.
- [→ UC-04](../usecases/04-compile-time-invariants.md) — Attach compile-time invariants directly to data.
