...
- [→ UC-01](../usecases/01-preventing-invalid-states.md) — Dependent types enforce invariants (e.g., non-empty vectors) at the type level.
- [→ UC-02](../usecases/02-domain-modeling-dependent-types.md) — Model domain constraints as type indices.
- [→ UC-04](../usecases/04-compile-time-invariants.md) — Attach proof obligations to data construction.
