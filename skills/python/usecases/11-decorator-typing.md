...
| Feature | Role | Link |
|---|---|---|
| Generics in decorators | `TypeVar` binds the function type through the decorator | [-> catalog/07](../catalog/07-generics-typevar.md) |
| `ParamSpec` / `TypeVarTuple` | Capture and forward full parameter signatures | [-> catalog/08](../catalog/08-paramspec-typevar-tuple.md) |
| `Callable` / `@overload` | Annotate the decorator's own input/output function types | [-> catalog/11](../catalog/11-callable-types-overload.md) |
| Generic classes / variance | Class-based decorators that preserve or transform types | [-> catalog/18](../catalog/18-generic-classes-variance.md) |
