...
| Feature | Role | Link |
|---|---|---|
| Dataclasses (frozen) | Immutable record types where field assignment is a type error | [-> catalog/06](../catalog/06-dataclasses-typing.md) |
| Final / ClassVar | Mark variables, methods, or classes as non-overridable / non-reassignable | [-> catalog/12](../catalog/12-final-classvar.md) |
