# Haskell Type System Constraint Guide

> Status: **Planned** — contributions welcome.

This section will map Haskell's type system features (type classes, GADTs, type families, etc.) to the constraints they can enforce at compile time.
